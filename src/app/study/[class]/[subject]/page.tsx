...
export default function SubjectDetailPage() {
  ...
  // Group materials by folder (materialType)
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Choose a folder and enter the PDF details to upload.
                </DialogDescription>
              </DialogHeader>
                  ...
                  {groupedMaterials[folderName].map((item) => (
                    <Card key={item.id} className="bg-card border-white/5 hover:border-primary/50 transition-all group">
                      ...
                      <CardFooter className="p-4 pt-0 flex gap-2">
                        <Button variant="outline" size="sm" className="flex-1 text-[10px] h-8 font-bold" asChild suppressHydrationWarning>
                          <a href={item.fileUrl} target="_blank" rel="noopener noreferrer">
                            <ExternalLink className="mr-1 h-3 w-3" /> View
                          </a>
                        </Button>
                        <Button variant="secondary" size="icon" className="shrink-0 h-8 w-8" asChild suppressHydrationWarning>
