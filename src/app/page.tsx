    ...
    <div className="flex flex-col gap-16 pb-20">
      ...
      <section className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold font-headline">Select Your Class</h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {classes.map((cls) => (
            <Link key={cls.name} href={cls.href}>
              <Card className="hover:border-primary transition-all duration-300 group overflow-hidden bg-card/50">
